<?php
// admin/pages/dataJurusan.php
require_once '../../config/koneksi.php';
require_once '../../auth/auth_check.php';
check_login();

$page_title = "Data Jurusan - SMKN 1 Kakas";
    ...
    <div class="container mx-auto px-4 py-10">
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <?php if ($is_admin): ?>
                    <button id="btnTambahJurusan" class="bg-sky-500 hover:bg-sky-600 text-white px-4 py-2 rounded transition duration-300">
                        Tambah Jurusan
                    </button>
                <?php endif; ?>
            </div>
    ...
    <div id="modalContainer" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden">
        <div class="modal-content bg-white rounded-lg w-full max-w-md mx-4 md:mx-auto mt-20 p-6">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-xl font-bold" id="modalTitle">Tambah Jurusan</h3>
                <button class="modal-close text-gray-600 hover:text-gray-800">&times;</button>
            </div>
            <form id="formJurusan" class="space-y-4">
                <input type="hidden" name="action" value="tambahJurusan">
            ...
            <div id="modalContent" class="hidden">
                <!-- Content untuk view mode akan diisi oleh JavaScript -->
            </div>
        </div>
    </div>

    <script src="../javascript/jurusanScript.js"></script>
</body>
